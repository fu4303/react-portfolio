    ...
    <section className='my-28' id='contact'>
      ...
      <div className='md:mx-6 flex flex-col flex-wrap md:flex-row justify-between'>
        <div className='md:w-6/12 md:px-0 p-5 my-5'>
          <div>
            <p className='font-bold'>Alec Campbell</p>
            <p className='font-thin'>Charlottesville, Virginia</p>
            <a href='mailto: iarenotamnot@gmail.com' className='border-b-2 mt-3 inline-block border-gray-500'>
              iarenotamnot@gmail.com
            </a>
          </div>
          ...
          <div className='flex flex-row flex-wrap mt-7'>
            <div className='mr-4'>
              <a href='https://www.linkedin.com/in/doc22940' target='_blank' rel='noreferrer'>
            ...
            <div className='mr-4'>
              <a href='https://github.com/fu4303' target='_blank' rel='noreferrer'>
                <span className='mb-2 flex flex-row items-end border border-gray-500 p-2 rounded-lg text-sm'>
            ...
            <a href='https://codepen.io/doc22940' target='_blank' rel='noreferrer'>
              <span className='mb-2 flex flex-row items-end border border-gray-500 p-2 rounded-lg text-sm'>
